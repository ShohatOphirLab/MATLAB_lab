...
handles.toolsNames = {'Plot Trajectories and Histograms', 'Show Tracking', 'Get Flies In Selected Region', 'Choose Files'' Names', 'Generate PI Plots', 'Run Flyogram'};%, 'Display All Changes Graphs', 'Plot Customized Outputs', 'Change Fix Parameters'};
...
% Define the path to ScriptChooserApp script
scriptChooserPath = 'W:\Flyogram';  % Folder containing ScriptChooserApp.m
% Add the path to MATLAB
addpath(scriptChooserPath);
